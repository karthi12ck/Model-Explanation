...
setup(
  name = 'Model_Explanation',         # How you named your package folder (MyLib)
  packages = ['Model_Explanation'],   # Chose the same as "name"
  ...
  keywords = ['snape', 'LIME', 'model explaination'],   # Keywords that define your package best
